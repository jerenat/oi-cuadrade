...
class Elem {
    ...
    attr(o) {
        ...
        var admitted = new Array(
            ...
            //para script
            "async", "defer", "referrerpolicy", "nomodule", "integrity",
        );
    ...
    before(b) {
        this.newElem.insertBefore(a, this.newElem.children[0]);
    };
...
function FuncOI(a) {
    ...
    */
    ...
    this.script = (url, cross, integry) => {

        let newScript = new Elem("script");
        ...
        if(typeof integry !== 'undefined'){
            newScript.attr({
                integrity: integry
            });
        };

        newScript.appTo($d.body);
    };
